...
reswir_stacked= np.stack ([np.median(reswir_stacked0918), np.median(reswir_stacked1013), np.median(reswir_stacked0908)],
sar_stacked= np.stack ([np.median(sar_stacked0918), np.median(sar_stacked1013), np.median(sar_stacked0908)],
rgbn_stacked= np.stack ([np.median(rgbn_stacked0918), np.median(rgbn_stacked1013), np.median(rgbn_stacked0908)],
